...
const styles = StyleSheet.create({
  ...
  exerciseCard: { width: '100%', maxWidth: 420, backgroundColor: '#FFF', borderRadius: 22, padding: 22, overflow: 'hidden' },
  ...
  exerciseInputRow: { width: '100%', flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderColor: '#DDEEDD', borderRadius: 14, paddingHorizontal: 14, marginHorizontal: 0, marginBottom: 18 },
  exerciseInput: { flex: 1, minWidth: 0, fontSize: 28, fontWeight: '800', color: '#222', paddingVertical: 12 },
